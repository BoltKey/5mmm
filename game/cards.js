function CardManager() {
	...
	this.pool = [
		...
		{name: "Statue", text: [], bg: "#ffffcf", cost: {red: 20, green: 0, blue: 30, black: 0}, vp: 15, f: function() {}},
		{name: "Collect taxes", text: ["Lose 10 vp.", "Gain 120 red and", "120 blue instantly"], bg: "#bbeeee", cost: {red: 0, green: 0, blue: 0, black: 100}, vp: -10, f: function() {resources.red += 120; resources.blue += 120}},
